                            ...
                            var $currentSlide = slick.find(".slick-current"),
                                status =
                                    ...
                                    $currentSlide.hasClass("is-custom-playing")
                                        ? "play"
                                        : "pause",
                                $animatingElements = $currentSlide.find(
                                    "[data-animation]"
                                );
                            controlVideo(slick, status);
                        });
                        $slider.on(
                            ...
                            function (event, slick, currentSlide, nextSlide) {
                                ...
                                var $nextSlide = $slider.find(
                                    ...
                                    $animatingElements = $nextSlide.find(
                                        "[data-animation]"
                                    );
                                $slider.slick("slickPlay");
                                controlVideo(slick, "pause");
                                ...
                                if ($this.hasClass("active")) {
                                    ...
                                    if (
                                        ...
                                        var slidenumber = $this
                                                .closest(".slick-slide")
                                                .data("slick-index"),
                                            allCount = $previews.find(
                                                ".slick-slide"
                                            ).length,
                                            showCount = $previews.find(
                                                ".slick-active"
                                            ).length;
                                        $carousel.slick(
                                            "slickGoTo",
                    ...
                    _filters: function _filters(obj) {
                        ...
                        $filtersLabel.each(function () {
                            ...
                            if ($this.hasClass(activeClass)) {
                                activeStart = true;
                                obj.defaults.currentFilter = $this.attr(
                                    dataAttr
                                );
                                $gallery.isotope();
                            }
