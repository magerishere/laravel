...
<div class="dropdn dropdn_account dropdn_fullheight">
	<a href="#" class="dropdn-link js-dropdn-link js-dropdn-link only-icon" data-panel="#dropdnAccount"><i class="fa fa-user-circle-o" aria-hidden="true" style="font-size: 30px"></i><span class="dropdn-link-txt">Account</span></a>
</div>
...
<div class="dropdn dropdn_account dropdn_fullheight">
	<a href="#" class="dropdn-link js-dropdn-link" data-panel="#dropdnAccount"><i class="fa fa-user-circle-o" aria-hidden="true" style="font-size: 30px"></i><span class="dropdn-link-txt">Account</span></a>
</div>
							</div>
						</div>
					</div>
...
<div class="dropdn_language">
	...
	<div class="dropdn-content-block">
		...
		<ul>
			...
			<li><a href="account-create.html"><span>Register</span><i class="fa fa-user-circle-o" aria-hidden="true" style="font-size: 30px"></i></a></li>
